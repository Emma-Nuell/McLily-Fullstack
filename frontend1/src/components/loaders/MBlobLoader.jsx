    ...
    <div>
      ...
      <div className='flex flex-col items-center gap-8 relative z-10'>
        ...
        <div className='relative w-40 h-40 flex items-center justify-center'>
          {/* Morphing blob */}
          <div
            className='absolute w-40 h-40 shadow-lg'
            style={{
          ...
          {/* Fixed M letter */}
          <div
            className='relative z-10 text-2xl font-black font-sevilla text-gray-900'
            style={{
              
              textShadow:
                "2px 2px 4px rgba(0, 0, 0, 0.3), 0 0 20px rgba(255, 255, 255, 0.2)",
            }}
          >
            M
          </div>
