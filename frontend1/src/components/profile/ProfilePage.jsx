...
import { Calendar, Camera, ChevronRight, CreditCard, Edit3, Heart, HelpCircle, LogOut, Mail, MapPin, Package, Phone, Settings, Shield, Star, StarIcon, User } from 'lucide-react';
     ...
     <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
       ...
       <div className='bg-background-white rounded-lg shadow-md border border-primary-300 dark:border-primary-100 p-6 text-center'>
         <Heart
           ...
           size={24}
         />
         <p className='text-xl font-bold text-gray-900 dark:text-gray-200'>8</p>
         <p className='text-sm text-gray-600 dark:text-gray-400'>
           Wishlist Items
         </p>
       </div>
       ...
       <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>
         <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between'>
           <div className='flex items-center'>
             <User className='text-primary-600 dark:text-primary-300 mr-3' size={26} />
             <div>
               <h1 className='text-lg font-bold text-text'>
                 Hey, {userProfile.lastName} {userProfile.firstName}
               </h1>
               ...
               {navigationItems.map((item) => (
                 ...
                 >
                   <div className='flex items-center'>
                     ...
                     <div>
                       <p className='font-medium text-gray-900 dark:text-gray-200'>{item.label}</p>
                   ...
                   <div className='flex items-center space-x-2'>
                     ...
                     <ChevronRight className='text-gray-500 dark:text-gray-400 group-hover:text-gray-700' size={18} />
                   </div>
                 </button>
               ))}
             </nav>
